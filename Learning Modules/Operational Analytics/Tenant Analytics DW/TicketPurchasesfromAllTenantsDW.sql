...
WHERE job_name = 'Ticket Purchases from all Tenants - DW'
...
WHERE job_name = 'Ticket Purchases from all Tenants - DW' and step_id IS NULL
...
--EXEC [jobs].[sp_stop_job] '588D4D05-4EF0-4783-85AF-E272CF9B2931'

-- Cleanup
--EXEC [jobs].[sp_delete_job] 'Ticket Purchases from all Tenants - DW'
